...
public class MainActivity extends BluetoothFragmentActivity implements DiscoveredDialogFragment.DiscoveredDialogListener {
    ...
    @BindView(R2.id.communication)
    EditText mEditText;
    @BindView(R2.id.send)
    ImageButton mSendBtn;

    @BindView(R2.id.client)
    ToggleButton mClientToggleBtn;
    @BindView(R2.id.serveur)
    ToggleButton mServerToggleBtn;

    @BindView(R2.id.connect)
    Button mConnectBtn;
    @BindView(R2.id.disconnect)
    Button mDisconnect;
